package org.app.portofolio.webui.hr.master.nationality.model;
...
public class NationalityListItemRenderer implements ListitemRenderer<MstNationality>{
	
	private NationalityService nationalityService = (NationalityService) SpringUtil.getBean("nationalityService");		
	
	@Override
	@SuppressWarnings({ "unchecked", "rawtypes" })
	public void render(Listitem item, final MstNationality mstNationality, int index) throws Exception {
		Listcell listcell;
		...
		if(mstNationality.getIdNationality() == null){
        	...
        	labelName.setValue(mstNationality.getNameNationality());
		...
		buttonSave.addEventListener(Events.ON_CLICK, new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				if(mstNationality.getIdNationality() == null){
					mstNationality.setNameNationality(textboxName.getValue());

					nationalityService.save(mstNationality);
					
					BindUtils.postGlobalCommand(null, null, "refreshAfterSaveOrUpdate", null);
				}else{
					mstNationality.setNameNationality(textboxName.getValue());

					nationalityService.update(mstNationality);
		...
		buttonEdit.addEventListener(Events.ON_CLICK, new EventListener() {
			public void onEvent(Event event) throws Exception {		
				...
				textboxName.setValue(mstNationality.getNameNationality());
			}					
		});
