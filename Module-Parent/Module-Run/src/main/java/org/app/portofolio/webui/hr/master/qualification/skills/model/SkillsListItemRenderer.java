...
public class SkillsListItemRenderer implements ListitemRenderer<MstSkill>{
		...
		buttonSave.addEventListener(Events.ON_CLICK, new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				if(mstSkill.getIdSkill() == null){
					...
					masterQualificationService.save(mstSkill);
					...
					masterQualificationService.update(mstSkill);
				...
				Messagebox.show("Do you really want to remove item?", "Confirm", Messagebox.OK | Messagebox.CANCEL, Messagebox.EXCLAMATION, new EventListener() {
				    public void onEvent(Event event) throws Exception {    	
				 		if (((Integer) event.getData()).intValue() == Messagebox.OK) {
				 			...
				 			masterQualificationService.delete(mstSkill);
