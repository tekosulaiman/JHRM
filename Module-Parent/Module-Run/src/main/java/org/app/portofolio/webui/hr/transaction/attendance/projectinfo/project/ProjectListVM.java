...
public class ProjectListVM {
	...
	public void doFilter(){
		...
		if(getName == null || "".equals(getName)) {
			...
			hashMap.put("projectName", getName);
			mstProjects = attendanceService.getByMstProjectRequestMap(hashMap);
			listitemRenderer = new ProjectListItemRenderer();
		}
	}
	...
	@Command
	public void doNew(){
		final ListModelList<MstProject> listModelListProject = (ListModelList) listboxProject.getModel();
		listModelListProject.add(0, new MstProject());
	}
